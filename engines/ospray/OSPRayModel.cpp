...
void OSPRayModel::_commitSpheres(const size_t materialId)
{
    ...
    ospSet1i(geometry, "offset_center", sizeof(uint64_t));
    ospSet1i(geometry, "offset_radius", sizeof(uint64_t) + 3 * sizeof(float));
...
void OSPRayModel::_commitCylinders(const size_t materialId)
{
    ...
    ospSet1i(geometry, "offset_v0", sizeof(uint64_t));
    ospSet1i(geometry, "offset_v1", sizeof(uint64_t) + 3 * sizeof(float));
    ospSet1i(geometry, "offset_radius",
             sizeof(uint64_t) + 6 * sizeof(float));
...
void OSPRayModel::_commitSDFGeometries()
{
    ...
    for (const auto& mat : _materials)
    {
        ...
        ospSetData(data, "neighbours", neighbourData);
