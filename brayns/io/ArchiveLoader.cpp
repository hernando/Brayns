...
LoaderSupport ArchiveLoader::getLoaderSupport() const
{
    return {LOADER_NAME, {"zip", "gz", "tgz", "bz2", "rar"}};
}
std::pair<std::string, PropertyMap> ArchiveLoader::getLoaderProperties() const
{
    return {LOADER_NAME, {}};
}
}
